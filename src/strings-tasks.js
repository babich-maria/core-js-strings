...
function reverseWords(str) {
  ...
  // Join the reversed words into the final string
...
function invertCase(str) {
  ...
  // Map over the characters and invert their case
  const invertedCharacters = characters.map((char) => {
    // Check if the character is uppercase or lowercase and invert the case
  ...
  // Join the inverted characters into the final string
...
function getStringFromTemplate(firstName, lastName) {
  // Use template string to generate the formatted string
...
function extractNameFromTemplate(value) {
  // Use regular expression to extract the name from the template
...
function unbracketTag(str) {
  ...
  // If the input does not have proper formatting, return as is
  return str;
}
...
function encodeToRot13(str) {
  // Helper function to perform ROT13 transformation on a single character
  ...
  // Use split and map to apply ROT13 transformation to each character
